"""Tests for brdocuments Pandas Series accessor integration."""
...
import brdocuments.integrations.pandas  # noqa: E402 - registers accessor


class TestIsValidAccessor:
    def test_is_valid_cpf_true(self) -> None:
        s = pandas.Series(["529.982.247-25"])
        result = s.brdocuments.is_valid_cpf()
    ...
    def test_is_valid_cnpj_true(self) -> None:
        ...
        result = s.brdocuments.is_valid_cnpj()
        assert result.iloc[0] == True  # noqa: E712
    ...
    def test_is_valid_ie_true(self) -> None:
        ...
        s = pandas.Series([ie])
        result = s.brdocuments.is_valid_ie("SP")
        assert result.iloc[0] == True  # noqa: E712
    ...
    def test_is_valid_cep_true(self) -> None:
        ...
        result = s.brdocuments.is_valid_cep()
        assert result.iloc[0] == True  # noqa: E712
    ...
    def test_is_valid_cnh_true(self) -> None:
        ...
        s = pandas.Series([cnh])
        result = s.brdocuments.is_valid_cnh()
        assert result.iloc[0] == True  # noqa: E712
    ...
    def test_is_valid_pis_true(self) -> None:
        ...
        s = pandas.Series([pis])
        result = s.brdocuments.is_valid_pis()
        assert result.iloc[0] == True  # noqa: E712
    ...
    def test_is_valid_renavam_true(self) -> None:
        ...
        s = pandas.Series([raw])
        result = s.brdocuments.is_valid_renavam()
        assert result.iloc[0] == True  # noqa: E712
    ...
    def test_is_valid_titulo_eleitor_true(self) -> None:
        ...
        s = pandas.Series([raw])
        result = s.brdocuments.is_valid_titulo_eleitor()
        assert result.iloc[0] == True  # noqa: E712
    ...
    def test_is_valid_cnj_true(self) -> None:
        ...
        s = pandas.Series([raw])
        result = s.brdocuments.is_valid_cnj()
        assert result.iloc[0] == True  # noqa: E712
    ...
    def test_is_valid_nfe_false(self) -> None:
        ...
        result = s.brdocuments.is_valid_nfe()
        assert result.iloc[0] == False  # noqa: E712

    def test_classify_pix_cpf(self) -> None:
        s = pandas.Series(["529.982.247-25"])
        result = s.brdocuments.classify_pix()
...
class TestFormatAccessor:
    def test_format_cpf(self) -> None:
        ...
        result = s.brdocuments.format_cpf()
    ...
    def test_format_cnpj(self) -> None:
        ...
        result = s.brdocuments.format_cnpj()
...
class TestMaskAccessor:
    ...
    def test_mask_cnpj(self) -> None:
        s = pandas.Series(["11.222.333/0001-81"])
        result = s.brdocuments.mask_cnpj()
