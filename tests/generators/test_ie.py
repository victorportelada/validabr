...
from pybrdoc.generators.ie import _VALID_STATES, generate_ie
...
class TestGenApRangeBranches:
    ...
    def test_gen_ap_yields_valid_in_any_range(self) -> None:
        ...
        from pybrdoc.generators.ie import _gen_ap
        from pybrdoc.validators.ie import is_valid_ie
    ...
    def test_gen_ap_else_branch_via_mock(self) -> None:
        ...
        from pybrdoc.generators import ie as ie_gen
        from pybrdoc.validators.ie import is_valid_ie
...
class TestGenAmTotalBranch:
    ...
    def test_gen_am_always_valid(self) -> None:
        from pybrdoc.generators.ie import _gen_am
        from pybrdoc.validators.ie import is_valid_ie
